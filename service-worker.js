...
const CACHE_NAME = 'malasense-v3';
const MODEL_CACHE = 'malasense-model-v3';
...
const MODEL_FILES = [
  ...
  // Thick smear model
  '/malasense-ai/model-thick/model.json',
  '/malasense-ai/model-thick/group1-shard1of8.bin',
  '/malasense-ai/model-thick/group1-shard2of8.bin',
  '/malasense-ai/model-thick/group1-shard3of8.bin',
  '/malasense-ai/model-thick/group1-shard4of8.bin',
  '/malasense-ai/model-thick/group1-shard5of8.bin',
  '/malasense-ai/model-thick/group1-shard6of8.bin',
  '/malasense-ai/model-thick/group1-shard7of8.bin',
  '/malasense-ai/model-thick/group1-shard8of8.bin'
];
